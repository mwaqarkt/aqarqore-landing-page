  ...
  return (
    <div className={`min-h-screen bg-[#F7F9FB] text-slate-900 overflow-x-hidden ${isRtl ? 'font-tajawal' : ''}`}>
      ...
      <section id="security" className="py-24 sm:py-32 bg-[#001433] text-white relative border-b border-blue-950/80 overflow-hidden">
        {/* Subtle Decorative Technical Grid & Deep Radial Ambient Cyan Glow */}
          ...
          <div className="space-y-12 lg:space-y-14">
            ...
            >
              ...
              <div className="relative w-44 h-44 sm:w-52 sm:h-52 flex items-center justify-center mb-6">
                ...
                <div className="absolute inset-8 rounded-full border border-sky-400/50 bg-[#001B3D] shadow-inner flex items-center justify-center overflow-hidden">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-mono font-black text-white tracking-wider mt-2">SECURITY CORE</span>
                    <span className="text-[8px] font-mono text-[#00D6A3] font-bold">✓ PROTECTED 24/7</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-[10.5px] font-mono pt-2">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#00142E] border border-blue-800/60 text-slate-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#39BFF5]" />
                  <span>ACCESS: 403 ENFORCED</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#00142E] border border-blue-800/60 text-slate-300">
                  <span className="w-1.5 h-1.5 rounded-full bg-violet-400" />
                  <span>REVOCATION: &lt; 60s</span>
                </div>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-blue-900/60 flex items-center justify-between text-[11px] font-mono">
                  <div className="flex items-center gap-1.5 text-slate-300">
                    ...
                    <span>Throttled Anti-Brute-Force</span>
                  </div>
              ...
              >
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#001228] border border-blue-900/70 space-y-2">
                    ...
                    <div className="space-y-1 text-[10px] font-mono">
                      <div className="flex items-center justify-between p-1 px-2 rounded-md bg-blue-950/80 border border-blue-800/40">
                        ...
                        <span className="text-[#39BFF5] font-bold">Team Leads Only ✓</span>
                      </div>
                      <div className="flex items-center justify-between p-1 px-2 rounded-md bg-blue-950/80 border border-blue-800/40">
                        <span className="text-slate-300">Agent:</span>
                        <span className="text-emerald-400 font-bold">Own Records Only ✓</span>
                      </div>
                ...
                <div className="mt-6 pt-4 border-t border-blue-900/60 flex items-center justify-between text-[11px] font-mono">
                  <div className="flex items-center gap-1.5 text-slate-300">
                    <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                    <span>Zero URL Leak Guarantee</span>
                  </div>
                  <span className="text-[10px] font-bold text-emerald-400 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30">
                    ENFORCED
                  </span>
              ...
              >
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#001228] border border-blue-900/70 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[9.5px] font-mono">
                      <div className="p-1.5 rounded-lg bg-blue-950/80 border border-blue-800/40 text-slate-300 flex items-center gap-1">
                        <span className="text-amber-400">1.</span> Status: Terminated
                      </div>
                      <div className="p-1.5 rounded-lg bg-blue-950/80 border border-blue-800/40 text-slate-300 flex items-center gap-1">
                        <span className="text-amber-400">2.</span> Session Killed
                      </div>
                      <div className="p-1.5 rounded-lg bg-blue-950/80 border border-blue-800/40 text-slate-300 flex items-center gap-1">
                        <span className="text-amber-400">3.</span> Tokens Revoked
                      </div>
                      <div className="p-1.5 rounded-lg bg-emerald-950/80 border border-emerald-500/50 text-emerald-300 flex items-center gap-1">
                        <span className="text-emerald-400">4.</span> Leads Reassigned ✓
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-blue-900/60 flex items-center justify-between text-[11px] font-mono">
                  <div className="flex items-center gap-1.5 text-slate-300">
                    <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                    <span>Sub-60s Session Kill</span>
                  </div>
            ...
            >
              <div className="flex items-center gap-2 text-slate-300">
                ...
                <span className="font-bold text-white">ENCRYPTED AT REST & IN TRANSIT</span>
              </div>
              <div className="hidden lg:block text-slate-600">•</div>
              <div className="flex items-center gap-2 text-slate-300">
                <ShieldCheck className="w-4 h-4 text-[#00D6A3]" />
                <span className="font-bold text-white">SERVER-SIDE ACCESS CONTROL</span>
              </div>
              <div className="hidden lg:block text-slate-600">•</div>
              <div className="flex items-center gap-2 text-slate-300">
                <UserCheck className="w-4 h-4 text-[#39BFF5]" />
                <span className="font-bold text-white">INSTANT SESSION REVOCATION</span>
              </div>
              <div className="hidden lg:block text-slate-600">•</div>
              <div className="flex items-center gap-2 text-slate-300">
                <Award className="w-4 h-4 text-[#F5B91E]" />
                <span className="font-bold text-white">AUDIT READY GCC SECURITY</span>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200/80 text-[#0858A8] text-xs font-mono font-bold uppercase tracking-wider shadow-2xs">
                ...
                <span>ENTIRE AGENCY CONNECTED</span>
              </div>
              ...
              <div className="space-y-3 pt-1">
                <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-2xs flex items-start gap-3.5 hover:border-slate-300 transition-all">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm font-bold text-slate-900">Instant Bidirectional Synchronization</div>
                    <div className="text-xs text-slate-500 mt-0.5">Every lead assignment, viewing log, and price change syncs in &lt; 10ms.</div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-2xs flex items-start gap-3.5 hover:border-slate-300 transition-all">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm font-bold text-slate-900">Zero Data Leakage &amp; Full Audit Trail</div>
                    <div className="text-xs text-slate-500 mt-0.5">Server-enforced RBAC and instant token offboarding protect agency records.</div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-2xs flex items-start gap-3.5 hover:border-slate-300 transition-all">
                  ...
                  <div>
                    <div className="text-xs sm:text-sm font-bold text-slate-900">Seamless Field-to-Desk Workflow</div>
                    <div className="text-xs text-slate-500 mt-0.5">Agents log basement viewings offline; directors approve commissions anywhere.</div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between pb-5 mb-6 border-b border-slate-100">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs font-mono font-bold text-slate-800 uppercase tracking-wider">
                      AGENCY TOPOLOGY • ALL 4 NODES LIVE
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between mb-2.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] font-mono text-slate-500">24/7 Buyer Qualification</div>
                          </div>
                        </div>
                        <span className="text-[9.5px] font-mono font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200">
                          VERIFIED
                  ...
                  <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-[#001E47] via-[#002D62] to-[#001738] text-white border-2 border-sky-400/50 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 text-[10.5px] font-mono text-emerald-300 bg-[#001430]/90 px-3 py-1.5 rounded-xl border border-emerald-400/30 shrink-0 shadow-inner">
                        <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                        <span>SYNCHRONIZED BACKBONE</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center justify-between mb-2.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] font-mono text-slate-500">Basement &amp; Field Viewings</div>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between mb-2.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] font-mono text-slate-500">2-Step Deal Signoffs</div>
                          </div>
                        </div>
      ...
      {/* -------------------------------------------------------------------------- */}
      {/* 8B. FAQ: ENTERPRISE INTERACTIVE KNOWLEDGE CONSOLE                          */}
      {/* -------------------------------------------------------------------------- */}
      <section id="faq" className="py-24 sm:py-32 bg-slate-50 text-slate-900 relative border-b border-slate-200/80 overflow-hidden">
        {/* Subtle Decorative Technical Micro-Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,48,104,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,48,104,0.03)_1px,transparent_1px)] bg-[size:3.5rem_3.5rem] pointer-events-none" />
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-blue-500/5 blur-[140px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
              {isRtl ? (
                ...
                'Answers to critical operational questions regarding portal ingestion, WhatsApp Cloud API compliance, offline viewings, and 48-hour onboarding.'
              )}
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search topics (e.g. Bayut, WhatsApp, commission, offline sync, 48 hours)..."
                className="w-full pl-12 pr-10 py-3.5 rounded-2xl bg-white border border-slate-200 shadow-sm text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0858A8] focus:ring-2 focus:ring-blue-100 transition-all"
              />
              {faqSearch && (
                <button
            ...
            <div className="flex items-center justify-center flex-wrap gap-2 pt-1">
              {[
                ...
                { id: 'routing', label: 'Speed & Routing' },
                { id: 'whatsapp', label: 'Meta WhatsApp' },
                { id: 'mobile', label: 'Offline Mobile' },
                { id: 'finance', label: 'Commissions & Audit' },
                { id: 'onboarding', label: '48h Onboarding' }
              ].map((tab) => (
                <button
                  key={tab.id}
          ...
          {/* Interactive Knowledge Cards Grid */}
                ...
                return (
                  <motion.div
                    ...
                    className={`rounded-3xl transition-all duration-200 border ${
                      isOpen 
                        ? 'bg-white border-sky-400/80 shadow-md ring-1 ring-sky-200/50' 
                  ...
                  >
                    <button
                      ...
                      className="w-full p-6 sm:p-7 flex items-start justify-between gap-4 text-left cursor-pointer group"
                    >
                      <div className="flex items-start gap-4">
                        <div className={`w-9 h-9 rounded-xl flex items-center justify-center font-mono font-bold text-xs shrink-0 transition-colors ${
                          isOpen ? 'bg-[#001D42] text-white' : 'bg-slate-100 text-slate-600 group-hover:bg-blue-50 group-hover:text-[#0858A8]'
                        }`}>
                          {faq.id}
                        </div>
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-2">
                            <span className="text-[9.5px] font-mono font-bold uppercase tracking-wider text-[#0858A8] bg-blue-50 px-2.5 py-0.5 rounded-md border border-blue-100">
                              {faq.tag}
                            </span>
                            <span className="text-[9.5px] font-mono font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200">
                              {faq.metric}
                            </span>
                          </div>
                      ...
                      <div className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-all ${
                        isOpen ? 'bg-[#0858A8] text-white shadow-xs' : 'bg-slate-100 text-slate-600 group-hover:bg-blue-100 group-hover:text-[#0858A8]'
                      }`}>
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        ...
                        >
                          <div className="px-6 sm:px-7 pb-7 pt-2 pl-16 sm:pl-20 text-sm sm:text-[15px] text-slate-600 leading-relaxed border-t border-slate-100 space-y-3">
                            <p>{faq.answer}</p>
                          </div>
                        </motion.div>
                      )}
          ...
          {/* Bottom Specialist Support Strip */}
          <div className="max-w-4xl mx-auto p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4 text-left">
              <div className="w-12 h-12 rounded-2xl bg-blue-50 border border-blue-200 text-[#0858A8] flex items-center justify-center shrink-0 font-bold">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <div>
                <div className="text-base font-bold text-slate-900">Have a specific enterprise requirement?</div>
                <div className="text-xs text-slate-500 mt-0.5">Direct consultation with solution architects in Dubai (DIFC) &amp; Doha</div>
              </div>
            </div>

            <a
              href={DEMO_CTA_URL}
              className="px-5 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs sm:text-sm whitespace-nowrap shadow-sm hover:shadow-md transition-all cursor-pointer flex items-center gap-2 shrink-0"
            >
